 ...
 * TODO
 * 
 * @author bgwan blog: www.bgwan.blog.163.com
 * @data: 2015年9月19日 下午2:35:48
 * @description 附近个人实体类
 * @version: V1.0
 */
...
public class Users extends Entity implements Parcelable {
	...
	public Users(String paramIMEI, int paramAvatar, String paramDevice,
			String paramNickname, String paramGender, int paramAge,
			String paramConstellation, String paramIP, String paramLogintime) {
		super();
