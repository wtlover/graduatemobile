package com.bgw.an.app.activity.chat.activity.message;
...
import com.bgw.an.app.activity.chat.adapter.ChatAdapter;
...
import com.bgw.an.app.activity.chat.file.FileState;
import com.bgw.an.app.activity.chat.socket.tcp.TcpClient;
import com.bgw.an.app.activity.chat.socket.tcp.TcpService;
import com.bgw.an.app.activity.chat.socket.udp.IPMSGConst;
import com.bgw.an.app.activity.chat.socket.udp.UDPSocketThread;
import com.bgw.an.app.activity.chat.sql.SqlDBOperate;
import com.bgw.an.app.activity.chat.util.AudioRecorderUtils;
...
import com.bgw.an.app.activity.chat.view.ChatListView;
import com.bgw.an.app.activity.chat.view.EmoteInputView;
import com.bgw.an.app.activity.chat.view.EmoticonsEditText;
...
import com.bgw.an.app.activity.chat.view.ScrollLayout;
import com.bgw.an.app.activity.chat.view.ScrollLayout.OnScrollToScreenListener;

public abstract class BaseMessageActivity extends BaseActivity implements
		OnScrollToScreenListener, OnClickListener, OnLongClickListener,
	...
	protected void initfolder() {
		if (null != BaseApplication.IMAG_PATH) {
			...
			THUMBNAIL_PATH = BaseApplication.THUMBNAIL_PATH + File.separator
					+ imei;
	...
	protected void showVoiceDialog(int flag) {
		if (mRecordDialog == null) {
			mRecordDialog = new Dialog(BaseMessageActivity.this,
					R.style.DialogStyle);
		...
		case 1:
			...
			mTvRecordDialogTxt
					.setText(getString(R.string.chat_dialog_record_cancel_up));
			break;

		default:
			mIvRecVolume.setImageResource(R.drawable.record_animate_01);
			mTvRecordDialogTxt
					.setText(getString(R.string.chat_dialog_record_cancel_move));
			break;
		}
	...
	protected void showFileChooser() {
		...
		try {
			startActivityForResult(Intent.createChooser(intent,
					getString(R.string.text_file_send_select)),
					FILE_SELECT_CODE);
		} catch (ActivityNotFoundException ex) {
			Toast.makeText(BaseMessageActivity.this,
					R.string.toast_file_manager_unavailable, Toast.LENGTH_SHORT)
					.show();
		}
	}
