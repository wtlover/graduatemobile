...
import com.bgw.an.R;
import com.bgw.an.app.activity.chat.entity.Avatar;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.image = (ImageView) convertView
					.findViewById(R.id.myprofile_avatarimage);
			convertView.setTag(viewHolder);
		} else {
			viewHolder = (ViewHolder) convertView.getTag();
		}
		viewHolder.image.setImageResource(((Avatar) pictures.get(position))
				.getImageId());
		return convertView;
	}
