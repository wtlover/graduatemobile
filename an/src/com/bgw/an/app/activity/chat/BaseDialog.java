package com.bgw.an.app.activity.chat;
...
public class BaseDialog extends Dialog implements
	...
	public static BaseDialog getDialog(Context context, int titleId,
		...
		return getDialog(context, titleId, message, null, null, null, null,
				null, null);
	}
	...
	public static BaseDialog getDialog(Context context, int titleId,
		...
		return getDialog(context, titleId, message, button1, listener1,
				button2, listener2, null, null);
	}
