...
import com.bgw.an.app.activity.chat.view.EmoticonsTextView;
...
public class ChatAdapter extends BaseObjectListAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (SessionUtils.isItself(msg.getSenderIMEI())) {
			mAvatarBitmap = ImageUtils.getAvatar(mApplication, mContext,
					Users.AVATAR + SessionUtils.getAvatar());
		} else {
		...
		case TYPE_LEFT_FILE:
			holder.mHtvLoadingProcess.setTag(FileUtils.getNameByPath(msg
					.getMsgContent()));
	...
	private void updateView(android.os.Message paramMsg) {
		...
		if (mListView != null) {
			HandyTextView htvView = (HandyTextView) mListView
					.findViewWithTag(FileUtils.getNameByPath(file.fileName));
