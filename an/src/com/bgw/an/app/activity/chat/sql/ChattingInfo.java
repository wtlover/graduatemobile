...
public class ChattingInfo {
	...
	public ChattingInfo(int id, int sendID, int receiverID, String date,
			String info) {
	...
	public String toString() {
		return "ID:" + getId() + " sendID:" + getSendID() + " receiverID:"
				+ getReceiverID() + " date:" + getDate() + " info:" + getInfo()
				+ " style：" + style;
	}
}
