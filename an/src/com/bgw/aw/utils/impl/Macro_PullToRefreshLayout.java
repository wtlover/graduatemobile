...
/**
 *blog: http://bgwan.blog.163.com/
 * date:2015.06
 * @author 孙顺涛
 */
public class Macro_PullToRefreshLayout extends RelativeLayout
{
	...
	public Macro_PullToRefreshLayout(Context context)
	{
		super(context);
		initView(context);
	}

	public Macro_PullToRefreshLayout(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		initView(context);
	}

	public Macro_PullToRefreshLayout(Context context, AttributeSet attrs, int defStyle)
	{
	...
	public interface OnRefreshListener
	{
		 ...
		 * 刷新操作
		 */
		void onRefresh(Macro_PullToRefreshLayout pullToRefreshLayout);

		/**
		 * 加载操作
		 */
		void onLoadMore(Macro_PullToRefreshLayout pullToRefreshLayout);
	}
